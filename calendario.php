...
<script>
    ...
    addSingle("Aplicación de examen de regularización Lic. 1ª Op.", "16 ene");
    ...
    addSingle("Aplicación de examen de regularización Lic. 2ª Op.", "3 feb");
    ...
    addSingle("Aplicación examen regularización Lic. 1ª Op. (junio)", "26 jun");
    addSingle("Entrega de boletas Chetumal", "30 jun");

    addEventRange("Aplicación de examen de regularización — 1ª Oportunidad", "2 jul", "3 jul");
    ...
    addEventRange("Inicio Período vacacional de verano", "13 jul", "7 ago");
    addEventRange("Realización de exámenes profesionales", "13 jul", "24 jul");

    addSingle("Fin Período vacacional de verano", "7 ago");
    ...
    addSingle("Aplicación de examen de regularización — 2ª Oportunidad", "18 ago");
                        ...
                        if (isDesktop) {
                            ...
                            if (!allActivities.length) {
                                ...
                                allActivities.forEach(e => {
                                    html += `<li><strong>Actividad: ${e.title}</strong><br><span style="font-size:0.75rem;">${e.description}</span></li>`;
                                });
                            ...
                            if (!allActivities.length) {
                                ...
                                let html = '';
                                allActivities.forEach(e => {
                                    html += `<li style="background:#f8fafc; margin-bottom:8px; padding:8px; border-radius:16px;"><strong>Actividad: ${e.title}</strong><br><span style="font-size:0.75rem;">${e.description}</span></li>`;
                                });
